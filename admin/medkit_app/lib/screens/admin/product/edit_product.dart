...
class ProductEdit extends StatefulWidget {
  ProductEdit({Key? key, required this.product}) : super(key: key);
...
class _ProductEditState extends State<ProductEdit> {
  ...
  Widget build(BuildContext context) {
    cProduct.product.value = widget.product.product;
    cProduct.categories.value = widget.product.categories;
    cProduct.price.value = widget.product.price;
    cProduct.jamOp.value = widget.product.jamOp;
    cProduct.photoUrl.value = widget.product.photoUrl;
    return Scaffold(
      // appBar: AppBar(
...
class ProductEditForm extends StatefulWidget {
  ProductEditForm({required this.product});
...
class _ProductEditFormState extends State<ProductEditForm> {
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            buildTitleField(widget.product.title.toString()),
            const SizedBox(
              height: 5,
            ),
            Text(
            ...
            buildDeksField(widget.product.deskripsi.toString()),
            Text(
              'Categoris',
              style: Theme.of(context).textTheme.titleMedium,
            ),
                  ...
                  if (cProduct.photoUrl.isEmpty &&
                    ...
                    if (cekdata == true) {
                      ...
                      Get.defaultDialog(
                            ...
                            child: SingleChildScrollView(
                              child: Column(
                                ...
                                children: [
                                  ...
                                  (cProduct.deskripsi.value.length >= 50)
                                      ? Text(
                                          'Deskripsi : \n' +
                                              cProduct.deskripsi.value
                                                  .substring(0, 50) +
                                              '.....',
                                        )
                                      : Text(
                                    ...
                                    children: [
                                      ...List.generate(
                                        ...
                                        (item) => Container(
                                          ...
                                          child: Text(cProduct.jamOp[item]),
                                        ),
                                      ),
                                    ],
                                  ),
                          ...
                          onConfirm: () {
                            setState(() {
                              cProduct.onEditProduct(widget.product.id);
                              cProduct.onRefresh();
                              price!.clear();
                              catgo!.clear();
                              Cproduct?.clear();
  ...
  TextFormField buildDeksField(oldDekskripsi) {
    return TextFormField(
        initialValue: oldDekskripsi,
        maxLines: null,
        minLines: 4,
  ...
  TextFormField buildTitleField(oldTitle) {
    return TextFormField(
